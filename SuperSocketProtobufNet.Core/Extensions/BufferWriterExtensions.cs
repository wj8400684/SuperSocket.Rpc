...
public static class BufferWriterExtensions
{
    ...
    /// <param name="value"></param>
    /// <returns>返回写入的长度</returns>
    public static int WriteLittleEndian(this IBufferWriter<byte> writer, string value)
    {
        var length = writer.WriteLittleEndian((byte)value.Length);
        length += writer.Write(value, Encoding.UTF8);
