...
public sealed class PacketDispatcher : IDisposable
{
    ...
    private readonly Dictionary<long, IPacketAwaitable> _waiters = new();

    public PacketAwaitable<TResponsePacket> AddAwaitable<TResponsePacket>(long packetIdentifier)
        where TResponsePacket : class
    {
    ...
    public void RemoveAwaitable(long identifier)
    {
        lock (_waiters)
        {
    ...
    public bool TryDispatch(RpcPackageInfo packet)
    {
